...
# TensorFlow log seviyesi (her platformda)
...
# Linux/diğer: CUDA_VISIBLE_DEVICES'e DOKUNULMAZ → NVIDIA GPU görünür kalır. GPU varsa GPU'da
#   eğitir (bkz. get_tensorflow); yoksa TensorFlow otomatik CPU'ya düşer.
...
if _IS_DARWIN or _FORCE_CPU:
    os.environ['TF_ENABLE_ONEDNN_OPTS'] = '0'          # Metal ile çakışmayı önle
    os.environ['TF_METAL_DEVICE_PLACEMENT'] = '0'      # otomatik Metal yerleşimini kapat
    ...
    # Linux/NVIDIA: GPU-öncelikli. Bellek büyümesini aç (ani OOM'u önler); CUDA'yı GİZLEME.
